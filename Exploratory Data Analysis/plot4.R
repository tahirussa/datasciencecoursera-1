...
par(mfrow = c(2, 2))
plot(data$DateIndex, data$Global_active_power, type = "l", 
     xlab = "", ylab = "Global Acitve Power")
plot(data$DateIndex, data$Voltage, type = "l", 
     xlab = "datetime", ylab = "Voltage")
plot(data$DateIndex, data$Sub_metering_1, type = "l", 
     xlab = "", ylab = "Energy sub metering")
lines(data$DateIndex, data$Sub_metering_2, col = "red")
lines(data$DateIndex, data$Sub_metering_3, col = "blue")
legend("topright", lty = "solid", lwd = 1, col = c("black", "red", "blue"), 
       legend = c("Sub_metering_1", "Sub_metering_2", "Sub_metering_3"), 
       bty = "n")
plot(data$DateIndex, data$Global_reactive_power, type = "l", 
