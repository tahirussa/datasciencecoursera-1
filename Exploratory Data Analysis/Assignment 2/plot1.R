...
## Split data frame and calculate sum of emissions.

splitNEI <- split(NEI, NEI$year)
...
png(file = "plot1.png", bg = "transparent", width = 640, height = 640)
plot(totalByYear$Year, totalByYear$TotalEmissions, 
     type = "l", main = "Total Emissions by Year", 
